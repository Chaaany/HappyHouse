// userInfo.js에서 데이터 받아오기
// userInfo.html에서 회원 정보 가져오기
var userIn;
if(localStorage.getItem("userI")){
  userIn = JSON.parse(localStorage.getItem("userI"));
}
window.onload=function(){
    document.getElementById("id").setAttribute("value",userIn.id);
    document.getElementById("password").setAttribute("value",userIn.password);
    document.getElementById("passwordCheck").setAttribute("value",userIn.password);
    document.getElementById("name").setAttribute("value",userIn.name);
    document.getElementById("tel").setAttribute("value",userIn.tel);
    document.getElementById("email").setAttribute("value",userIn.email);
    document.getElementById("address").setAttribute("value",userIn.address); 
}
